...
(function() {{
    ...
    var poll = setInterval(function() {{
        ...
        if (ctrl && !document.getElementById('rc-wrap')) {{
            ...
            b.title = 'Recenter'; b.innerHTML = '\u2295'; b.href = '#';
    ...
    st.markdown(
        ...
        <div style="text-align: left; padding: 0.75rem 0;">
            <div style="display:flex; align-items:center; gap:0.75rem;">
                ...
                ">🌾</div>
                <div>
                    <h2 style="margin:0;color:#e8edf2;font-weight:700;font-size:1.1rem;">Spot Spraying · Smart Coverage</h2>
                    <p style="margin:0.15rem 0 0 0;color:#5fa8a3;font-size:0.8rem;">Intelligent Agricultural Automation</p>
                </div>
            </div>
        </div>
        """,
