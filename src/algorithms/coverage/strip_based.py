...
class StripBasedCoverageStrategy(CoverageStrategy):
    ...
    def generate(self, polygons: Sequence[Polygon], context: CoverageContext) -> list[Polygon]:
        ...
        while y < maxy:
            ...
            clipped = make_valid_if_needed(rotated.intersection(band), fix_invalid=context.config.fix_invalid_geometries)
        ...
        dissolved = dissolve_polygons(selected_bands, fix_invalid=context.config.fix_invalid_geometries)
